...
const AUDIT_DATA = [
  {
    ...
    role: 'IT Lead',
    action: 'ASSIGN_PIC',
    resource: 'IT-2026-000004',
    detail: 'PIC ditugaskan: Dian Kusuma. Prioritas: High. SLA: 48 jam.',
    ip: '10.0.1.45',
  },
  {
    id: 'aud2',
    ...
    resource: 'IT-2026-000006',
    detail: 'Eskalasi Level 2: Notifikasi dikirim ke IT Lead dan Manager.',
    ip: 'system',
  },
  {
    id: 'aud3',
    ...
    role: 'QA',
    action: 'QA_PASS',
    resource: 'IT-2026-000001',
    detail: 'Internal testing PASSED. 6/6 test case lulus. Tiket diteruskan ke UAT.',
    ip: '10.0.1.67',
  },
  {
    id: 'aud4',
    ...
    role: 'Admin',
    action: 'USER_CREATE',
    resource: 'USR-NEW-009',
    detail: 'User baru dibuat: linda.baru@apg.co.id, Role: User, Divisi: IT.',
    ip: '10.0.1.12',
  },
  {
    id: 'aud5',
    ...
    resource: 'IT-2026-000005',
    detail: 'Tiket divalidasi dan diteruskan ke IT Lead untuk triage.',
    ip: '10.0.1.23',
  },
  {
    id: 'aud6',
    ...
    resource: 'IT-2026-000005',
    detail: 'Tiket baru dibuat: Penambahan Role Baru: Auditor Internal. Kategori: Change.',
    ip: '10.0.2.34',
  },
  {
    id: 'aud7',
    ...
    resource: 'IT-2026-000003',
    detail: 'Status diubah dari in_progress ke internal_testing.',
    ip: '10.0.1.45',
  },
  {
    id: 'aud8',
    ...
    resource: 'SLA-RULE-001',
    detail: 'Aturan SLA Critical diupdate: 24 jam → 4 jam untuk kategori Production Down.',
    ip: '10.0.1.12',
  },
  {
    id: 'aud9',
    ...
    action: 'SLA_BREACH',
    resource: 'IT-2026-000003',
    detail: 'Tiket melewati batas SLA 48 jam. Eskalasi Level 1 dikirim.',
    ip: 'system',
  },
  {
    id: 'aud10',
    ...
    action: 'QA_SUBMIT',
    resource: 'IT-2026-000001',
    detail: 'Hasil pengujian QA disubmit: PASS. Tiket diteruskan ke fase UAT.',
    ip: '10.0.1.67',
  },
  {
    id: 'aud11',
    ...
    resource: 'IT-2026-000007',
    detail: 'Deployment disetujui oleh Manager. Catatan: Sesuai kebutuhan OJK compliance.',
    ip: '10.0.1.78',
  },
  {
    id: 'aud12',
    ...
    action: 'SLA_BREACH',
    resource: 'IT-2026-000001',
    detail: 'Tiket melewati SLA 24 jam. Eskalasi otomatis Level 2 dikirim.',
    ip: 'system',
  },
]
...
export default function AuditLog() {
  ...
  return (
    <div>
      <PageHeader title="Audit Log" subtitle="Rekam jejak seluruh aktivitas dan perubahan sistem" />
        ...
        <Table headers={['Waktu', 'Aktor', 'Role', 'Aksi', 'Resource', 'Detail', 'IP']}>
          {filtered.map((log) => (
            <TR key={log.id} highlight={log.action.includes('BREACH') || log.action.includes('ESCALATION')}>
              ...
              <TD>
                <span
                  className={`text-xs px-2 py-0.5 rounded-full font-medium whitespace-nowrap ${ACTION_COLORS[log.action] || 'bg-gray-100 text-gray-600'}`}
                >
                  {log.action}
                </span>
              </TD>
