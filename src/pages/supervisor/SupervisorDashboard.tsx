  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <KPICard
          title="Closed Bulan Ini"
          value={KPI_DATA.closedThisMonth}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <SectionCard
            ...
            actions={
              <Button variant="primary" size="sm" onClick={() => navigate('/supervisor/validation-queue')}>
                Lihat Semua
              </Button>
            }
          >
            {pending.length === 0 ? (
              ...
              <div className="space-y-3">
                {pending.map((t) => (
                  <div
                    key={t.id}
                    onClick={() => navigate('/supervisor/validation-queue')}
                    className="border border-amber-200 bg-amber-50/30 rounded-xl p-4 cursor-pointer hover:shadow-md transition-all"
                  >
