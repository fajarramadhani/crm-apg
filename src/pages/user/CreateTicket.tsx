      ...
      <div className="flex items-center gap-2 mb-6">
        {[1, 2, 3].map(s => (
          <div key={s} className="flex items-center gap-2">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold transition-all ${s === step ? 'bg-[#1E3A8A] text-white' : s < step ? 'bg-emerald-500 text-white' : 'bg-gray-200 text-gray-500'}`}>
              {s < step ? '✓' : s}
            </div>
      ...
      <Card className="p-6">
        {step === 1 && (
          <div className="space-y-5">
            <h3 className="text-base font-semibold text-gray-900 pb-3 border-b border-gray-100">Informasi Dasar Tiket</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Select
                ...
                options={[{ value: '', label: '— Pilih Aplikasi —' }, ...APPLICATIONS.map(a => ({ value: a, label: a }))]}
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center hover:border-[#1E3A8A]/40 transition-colors cursor-pointer">
                ...
                <p className="text-sm text-gray-500">Drag & drop file atau <span className="text-[#1E3A8A] font-medium">browse</span></p>
            ...
            <div className="flex justify-between">
              ...
              <Button variant="primary" onClick={() => setStep(3)} disabled={!form.description}>Lanjut →</Button>
            </div>
          </div>
        )}
          ...
          <div className="space-y-5">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex gap-3">
              ...
              <div className="text-sm text-amber-800">
                ...
                <p className="mt-1">Tiket akan diteruskan ke Supervisor divisi Anda untuk divalidasi. Prioritas akhir akan ditentukan oleh IT Lead.</p>
              </div>
            </div>

            <div className="flex justify-between">
              <Button variant="secondary" onClick={() => setStep(2)}>← Kembali</Button>
              <Button variant="primary" onClick={handleSubmit}>📤 Kirim Tiket</Button>
            </div>
          </div>
        )}
      </Card>
